...
namespace ExcelBrowser.Interop {
    ...
    static class WindowsApiUtil {
        ...
        public static xlApp ExcelApplicationFromMainWindowHandle(int mainWindowHandle) {
            int childHandle = ChildHandleFromMainHandle(mainWindowHandle);
        ...
        private static int ChildHandleFromMainHandle(int mainHandle) {
            int childHandle;
            EnumChildWindows(mainHandle, NextChildWindowHandle, out childHandle);
            return childHandle;
        }
        ...
        [DllImport(USER32)]
        private static extern bool EnumChildWindows(int hWndParent, EnumChildCallback lpEnumFunc, out int lParam);
        ...
        private static bool NextChildWindowHandle(int currentChildHandle, ref int nextChildHandle) {
            var className = "EXCEL7";

            if (GetClassName(currentChildHandle) == className) {
